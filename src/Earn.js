...
console.log("sys", systemratio)
  ...
  //connect wallet
    ...
    const ReadDeposits = async () => {
        try {
            ...
            if (ethereum) {
                ...
                let tx = await contract.accountDeposits(currentAccount);
                //await tx.wait();
                console.log("white", ethers.formatUnits(tx ? tx[0].toString(): "0", 18))
                setDeposit(ethers.formatUnits(tx ? tx[0].toString(): "0", 18))
                //return tx
                //console.log("tx", tx[1])
                //setDeposit(tx[1])
            }
    ...
    ReadDeposits()
    const { data6, error6 } = useSWR('ReadDeposits', ReadDeposits)
    ...
    const { data2, error2} = useSWR('ReadTVL', ReadTVL, {refreshInterval: 1000})
    const { data7, error7} = useSWR('ReadDeposits', ReadDeposits, {refreshInterval: 1000})
    ...
    <Box sx={{ flexGrow: 1 }} className='css-11roni71'>
        ...
        <div className='css-1j5lrqm'>
          ...
          <div className='css-q2axfv'>
            <Button variant="contained" className='css-gkaur5'>
                ...
                <Typography className='css-1o1o526'>{systemratio.toFixed()} %</Typography>
            </Button>
          </div>
      ...
      <Main open={open} className='css-142ldf2'>
        <Container maxWidth="lg" className='css-18bd6du'>
            <Grid container className='css-sag665'>
                <Grid item xs={12} sm={12} md={12} lg={12} className='css-1y1wpyuS'>
                    <div className='css-j7qwjs'>
                        <Typography className='css-o9ltdn'>
                            <span className='white'>Put your igUSD to work</span>
                        </Typography>
                    </div>
                </Grid>
                <Grid item xs={12} sm={12} md={12} lg={12} className='css-15j76c0'>
                    <Card className='css-93jgv3'>
                        <div className='css-16e1l0i'>
                            <Accordion className='ne'>
                                <AccordionSummary className='css-u4p24i' expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                    <Typography className='css-t2gyfh'>Stability Pool</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <CardContent className='css-jncbc9'>
                                        <Paper className='css-1hca15l'>
                                            <Table aria-label="table" className='css-1mw8yp1'>
                                                <TableHead className='css-3wovtf'>
                                                    <TableRow className='css-2cnnfh'>
                                                        <TableCell className='css-j0s5nc'>
                                                            <Typography className='css-njx8b9'></Typography>
                                                        </TableCell>
                                                        <TableCell className='css-j0s5nc'>
                                                            <Typography className='css-njx8b9'>TVL</Typography>
                                                        </TableCell>
                                                        <TableCell className='css-j0s5nc'>
                                                            <Typography className='css-njx8b9'>Your Deposits</Typography>
                                                        </TableCell>
                                                        <TableCell className='css-j0s5nc'>
                                                            <Typography className='css-njx8b9'></Typography>
                                                        </TableCell>
                                                ...
                                                <TableBody className='css-1xnox0e'>
                                                    <TableRow className='css-2cnnfh'>
                                                        <TableCell className='css-18ghe5y'>
                                                        <div class="MuiBox-root css-19hiiex">
                                                            <img src="https://i.imgur.com/oBcq5xS.png" alt="0x4591DBfF62656E7859Afe5e45f6f47D3669fBB28-icon" height="32" width="32" />
                                                                &nbsp;
                                                            <p class="MuiTypography-root MuiTypography-body1 css-19r0dcb">igUSD</p>
                                                        </div>
                                                        </TableCell>
                                                        <TableCell className='css-1uxclun'>
                                                            <p class="MuiTypography-root MuiTypography-body1 css-19r0dcb"> 
                                                                <span>$ {Number(TVL).toFixed(2)} igUSD</span>
                                                            </p>
                                                        </TableCell>
                                                        <TableCell className='css-1uxclun'>
                                                            <p class="MuiTypography-root MuiTypography-body1 css-19r0dcb">
                                                                <span className='fiw'>
                                                                    <img src="https://i.imgur.com/oBcq5xS.png" alt="0x4591DBfF62656E7859Afe5e45f6f47D3669fBB28-icon" height="22" width="22" />
                                                                        &nbsp;
                                                                        {Number(Deposit).toFixed(2)}
                                                                </span>
                                                            </p>
                                                        </TableCell>
                                                        <TableCell className='css-1jw32q7'>
                                                            <div className='css-3l2m3g'>
                                                                <Link to="/earn/stabilitypool">
                                                                    <Button className='css-1r3fpwf' variant="contained">Manage</Button>
                                                                </Link>
                                                            </div>
                                                        </TableCell>
                                                    </TableRow>
                ...
                <Card className='css-93jgv3'>
                    <div className='css-16e1l0i'>
                        <Accordion className='ne'>
                            <AccordionSummary className='css-u4p24i' expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                                <Typography className='css-t2gyfh'>LP Tokens</Typography>
                            </AccordionSummary>
                        </Accordion>
                    </div>
                </Card>
