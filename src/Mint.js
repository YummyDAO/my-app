...
async function Checkfee(value) {
    try {
        ...
        if (ethereum) {
            ...
            let tx = await contract.getBorrowingFee(ethers.parseUnits(value ? value.toString() : "0", 18));
            //await tx.wait();
                    ...
                    <Grid container className='css-isbt42'>
                        <Grid item xs={12} sm={12} md={6} lg={6} className='css-15j76c0'>
                            <Card className='css-16euf7l'>
                                ...
                                title= {<Typography className='css-1e2y9ep'>Mint igUSD</Typography>}
                                >
                                </CardHeader>
                                    <CardContent className='css-vs0weu'>
                                            ...
                                            <div className='css-gmkiuq '>
                                                <div className='css-1fxv11n'>
                                                    ...
                                                    <Typography className='css-126nj8n '>
                                                        <span className='bal1'>Coll &nbsp;</span>
                                                        <span className='bal2' >{Number(uColl).toFixed(2)}&nbsp;rETH</span>
                                                    </Typography>
                                                </div>
                                                <div className='css-lffzzs'>
                                                    <TextField className='css-skinv8' label="Enter Collateral amount" /*onChange={e => setinputColl(e.target.value)}*/ onChange={change1}/>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className='css-124zb1q '>
                                                    <div className='css-lffzzs'>
                                                        <div className='css-skinv8'>
                                                            <div className='p23'>
                                                            {show ? <Typography style={{ color: `${checkColor(userratio.toFixed(2))}` }} className='css-10uwbb8 pi'>{userratio.toFixed(2)} %</Typography> : <Typography style={{ color: `${checkColor(vratio.toFixed(2))}` }} className='css-10uwbb8 pi'>{vratio.toFixed(2)} %</Typography>}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className='css-gmkiuq '>
                                                <div className='css-1fxv11n'>
                                                    ...
                                                    <Typography className='css-126nj8n '>
                                                        <span className='bal1'>igUSD Borrowed &nbsp;</span>
                                                        <span className='bal2' >{Number(uDebt).toFixed(2)}&nbsp;igUSD</span>
                                                    </Typography>
                                                </div>
                                                <div className='css-lffzzs'>
                                                    <TextField className='css-skinv8' label="Enter igUSD amount" /*onChange={e => setinputDebt(e.target.value)}*/ onChange={change}/>
                                                </div>
                                            </div>
                                        ...
                                        <div className='css-s0rxs7'>
                                            <div className='css-xrla66'>
                                                <div className='css-16p6myl'>
                                                    ...
                                                    <Typography className='css-q0ydvy'>{/*inputDebt*/ Number(inputDebt) < Number(uDebt) ? uDebt - inputDebt: inputDebt}  &nbsp; igUSD</Typography>
                                                </div>
                                                <div className='css-16p6myl'>
                                                    <Typography className='css-10x6qtf'>+Mint Fee</Typography>
                                                    <Typography className='css-q0ydvy'>(0.50%){Number(fee).toFixed(2)} &nbsp; igUSD</Typography>
                                                </div>
                                                <div className='css-16p6myl'>
                                                    <Typography className='css-10x6qtf'>+Liquidation Reserve</Typography>
                                                    <Typography className='css-q0ydvy'>{uColl ? 200 : 200} &nbsp; igUSD</Typography>
                                                </div>
                                            </div>
