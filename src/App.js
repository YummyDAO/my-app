...
console.log("sys", systemratio)
  ...
  const handleClose = () => {
    ...
    const ReadBalance = async () => {
        try {
          ...
          if (ethereum) {
              ...
              setDebt(ethers.formatUnits(tx ? tx.toString(): "0", 18))
              return tx;
          }
        } catch(error) {
          console.log(error);
    ...
    const { data, error } = useSWR('ReadBalance', ReadBalance)
    ...
    const ReadTotal = async () => {
        try {
            ...
            if (ethereum) {
                ...
                //await tx.wait();
                console.log("white", ethers.formatUnits(tx ? tx.toString(): "0", 18))
                setColl(ethers.formatUnits(tx ? tx.toString(): "0", 18))
                return tx
            }
          } catch(error) {
            console.log(error);
    ...
    const { data1, error1 } = useSWR('ReadTotal', ReadTotal)
  ...
  return (
    <Box sx={{ flexGrow: 1 }} className="css-11roni71">
          ...
          {auth && (
            <div className='flex css-w0ow2w'>
              ...
              >
                ...
                <MenuItem onClick={handleClose} className='css-u77kgq none1'>Vaults list</MenuItem>
                ...
                <MenuItem onClick={handleClose} className='css-u77kgq none1'>Discord</MenuItem>
      ...
      <Main open={open} className='css-142ldf2'>
        ...
        <Grid container className='css-1v86qlq'>
            <Grid item xs={12} sm={12} md={12} lg={12} className='css-15j76c0'>
                <div className='css-j7qwjs'>
                <Typography variant="h3"  className='css-o9ltdn'>
                <span className='css-s3vbax'>Choose a collateral to borrow against</span>  
                </Typography>
                </div>
            </Grid>
            <Grid container className='css-keky9l'>
                <Grid item xs={12} sm={12} md={5} lg={5} className='css-1ha4th6'>
                    <div className='css-79elbk'>
                        <Card className='css-4ziz17'>
                            <CardContent className='css-jncbc9'>
                                <div className='collateral-card-header'>
                                    <Typography className='css-lyv0h0'>rETH</Typography>
                                </div>
                                <div className='css-11yycbb'>
                                    <span>
                                        <div className='css-44jcej'>
                                            <Typography className='css-6wkcva' >Total Value Locked</Typography>
                                            <Typography className='css-lkdbj6'>{Number(Coll).toFixed(2)}&nbsp; rETH</Typography>
                                        </div>
                                    </span>
                                    <span>
                                        <div className='css-44jcej'>
                                            <Typography className='css-6wkcva' >Minted igUSD</Typography>
                                            <Typography className='css-lkdbj6'>{Number(Debt).toFixed(2)}&nbsp; igUSD</Typography>
                                        </div>
                                    </span>
                                    <span>
                                        <div className='css-44jcej'>
                                            <Typography className='css-6wkcva' >MCR</Typography>
                                            <Typography className='css-lkdbj6'>120%</Typography>
                                        </div>
                                    </span>
                                    <span>
                                        <div className='css-44jcej'>
                                            <Typography className='css-6wkcva' >Staked Ether APR</Typography>
                                            <Typography className='css-lkdbj6'> 3.5%</Typography>
                                        </div>
                                    </span>
                                </div>
                                <div className='css-ygcku3'>
                                <Link to="/vault/rETH">
                                    <Button variant="contained" size="medium" className='css-1r3fpwf' >Choose rETH</Button>
                                </Link>
                                </div>
                            </CardContent>
                        </Card>
                        <div className='css-ugszen'>
                            <Link href="#" color="inherit" underline="none" className='css-6vhoi0'>Get rETH on Curve</Link>
                        </div>
                    </div>
                </Grid>
            </Grid>
